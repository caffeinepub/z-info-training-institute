...
function StatCounter({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center text-center px-6 py-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-orange-500 mb-2", children: icon }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm md:text-base text-blue-200 mt-1 font-medium", children: label })
  ] });
}
const topics = [
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Wrench, { className: "w-7 h-7" }),
    title: "Mobile Hardware Repairing",
    hindi: "मोबाइल के अंदर के सभी पार्ट्स जैसे बैटरी, चार्जिंग पोर्ट, कैमरा, स्पीकर आदि की मरम्मत सीखें।",
    english: "Learn to repair internal components like battery, charging port, camera, speaker and more."
  },
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Smartphone, { className: "w-7 h-7" }),
    title: "Mobile Software / Flashing",
    hindi: "मोबाइल सॉफ्टवेयर प्रॉब्लम, फ्लैशिंग, IMEI रिपेयर और फर्मवेयर अपडेट सीखें।",
    english: "Learn software troubleshooting, flashing, IMEI repair and firmware updates."
  },
  {
    ...
    english: "Master IC, capacitor, diode and transistor level motherboard repairs."
  },
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Droplets, { className: "w-7 h-7" }),
    title: "Water Damage Repair",
    hindi: "पानी से खराब हुए मोबाइल को ठीक करना, ऑक्सीडेशन हटाना और पार्ट्स बचाना सीखें।",
    english: "Learn to restore water-damaged phones, remove oxidation and salvage components."
  },
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Monitor, { className: "w-7 h-7" }),
    title: "Display & Touch Replacement",
    hindi: "LCD, AMOLED और टच स्क्रीन को बदलना और बाइंडिंग करना सीखें।",
    english: "Learn to replace LCD, AMOLED and touch screens with perfect bonding."
  },
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Battery, { className: "w-7 h-7" }),
    title: "Battery & Charging Issues",
    hindi: "बैटरी स्वेलिंग, चार्जिंग नहीं होना, फास्ट ड्रेन जैसी समस्याएं ठीक करना सीखें।",
    english: "Diagnose and fix battery swelling, charging failures and fast drain issues."
  },
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Settings, { className: "w-7 h-7" }),
    title: "Tools & Equipment Usage",
    hindi: "SMD स्टेशन, मल्टीमीटर, हॉट एयर गन और सभी प्रोफेशनल टूल्स का सही उपयोग सीखें।",
    english: "Master SMD station, multimeter, hot air gun and all professional repair tools."
  },
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Store, { className: "w-7 h-7" }),
    title: "Business & Shop Management",
    hindi: "अपनी खुद की मोबाइल रिपेयरिंग शॉप कैसे शुरू करें, GST, बिलिंग और कस्टमर मैनेजमेंट सीखें।",
    english: "Learn to start your own repair shop, GST registration, billing and customer management."
  }
];
const students = [
  {
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-poppins min-h-screen bg-white", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-[#0B1F3B] text-white text-xs py-2 px-4 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-4 flex-wrap justify-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-3 h-3 text-orange-400" }),
        "Hajipur, Vaishali, Bihar"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline text-gray-500", children: "|" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "a",
        {
          href: "tel:8340505173",
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "w-3 h-3 text-orange-400" }),
            " 8340505173"
          ]
        }
      ),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "a",
        {
          ...
          className: "flex items-center gap-1 hover:text-orange-300 transition-colors",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Youtube, { className: "w-3 h-3 text-red-400" }),
            " Z.info7771"
          ]
        }
      )
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-50 bg-white shadow-md", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "max-w-7xl mx-auto px-4 py-3 flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            ...
            "data-ocid": "nav.link",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-xl bg-[#0B1F3B] flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-orange-400 font-extrabold text-lg", children: "Z" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-extrabold text-xl text-[#0B1F3B]", children: "Z.info" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-gray-500 leading-none", children: "Mobile Training" })
              ] })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "hidden md:flex items-center gap-6", children: navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            href: link.href,
            ...
            children: [
              link.label,
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -bottom-1 left-0 w-0 h-0.5 bg-orange-500 transition-all group-hover:w-full" })
            ]
          }
        ) }, link.label)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:flex items-center gap-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#enquiry", "data-ocid": "nav.primary_button", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { className: "bg-orange-500 hover:bg-orange-600 text-white rounded-full px-5 font-semibold shadow-orange transition-all hover:shadow-lg", children: "Free Demo" }) }) }),
      ...
      mobileMenuOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:hidden bg-white border-t border-gray-100 px-4 py-4 flex flex-col gap-3", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "section",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 right-0 w-1/2 h-full opacity-10 pointer-events-none", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "w-full h-full",
              style: {
                background: "radial-gradient(circle at 70% 50%, #0B1F3B 0%, transparent 70%)"
              }
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-20 -left-20 w-96 h-96 rounded-full bg-orange-500/5 blur-3xl" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 flex flex-col lg:flex-row items-center gap-12", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 animate-fade-in", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 bg-orange-50 border border-orange-200 rounded-full px-4 py-1.5 mb-6 animate-float", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 rounded-full bg-orange-500 animate-pulse" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-orange-600 font-semibold text-sm", children: "🎉 2 Days FREE Demo Class Available!" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-tight mb-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#0B1F3B]", children: "Z.info" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-orange-500", children: "MOBILE" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#0B1F3B]", children: "TRAINING" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#1F5E8D]", children: "INSTITUTE" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl sm:text-2xl font-bold text-[#0B1F3B] mb-2", children: "बने मोबाइल इंजीनियर मात्र 90 दिनों में" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-orange-500 font-semibold italic mb-6", children: '"हुनर है तो कदर है"' }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-gray-600 mb-8 max-w-xl leading-relaxed", children: [
                "Join Bihar's most trusted mobile repairing institute. Get hands-on training, 100% job guarantee, and start earning",
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "₹40,000–₹50,000+" }),
                " per month."
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "tel:8340505173", "data-ocid": "hero.primary_button", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { className: "flex items-center gap-2 bg-orange-500 hover:bg-orange-600 text-white rounded-full px-8 py-6 text-base font-bold shadow-orange hover:shadow-xl transition-all hover:scale-105", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 flex flex-wrap gap-4", children: [
                {
                ...
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-orange-500", children: badge.icon }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-gray-700", children: badge.label })
                  ]
                },
                badge.label
              )) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 flex justify-center lg:justify-end animate-slide-up", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-72 h-72 sm:w-96 sm:h-96 rounded-3xl bg-gradient-to-br from-[#0B1F3B] to-[#1F5E8D] flex items-center justify-center shadow-2xl animate-float", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center text-white", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-7xl mb-4", children: "📱" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-extrabold", children: "Become a" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-orange-400 text-3xl font-extrabold", children: "Mobile Expert" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg mt-2 opacity-80", children: "in just 90 Days!" })
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-4 -right-4 bg-white rounded-2xl shadow-card p-3 border border-orange-100", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(IndianRupee, { className: "w-5 h-5 text-green-500" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500", children: "Monthly Salary" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-sm text-green-600", children: "₹40K–50K+" })
                ] })
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -bottom-4 -left-4 bg-white rounded-2xl shadow-card p-3 border border-blue-100", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Award, { className: "w-5 h-5 text-orange-500" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500", children: "Placement" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-sm text-orange-600", children: "100% Guaranteed" })
                ] })
              ] }) })
            ] }) })
          ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-[#0B1F3B] py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 grid grid-cols-2 md:grid-cols-4 gap-2 divide-y md:divide-y-0 md:divide-x divide-white/10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        StatCounter,
        {
          value: 90,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        StatCounter,
        {
          ...
          suffix: "%",
          label: "Job Guarantee",
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { className: "w-8 h-8" })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        StatCounter,
        {
          ...
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx(IndianRupee, { className: "w-8 h-8" })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        StatCounter,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "about", className: "py-20 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12 reveal", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block bg-orange-50 text-orange-600 text-xs font-bold uppercase tracking-widest px-4 py-1.5 rounded-full mb-4", children: "Career Opportunity" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-3xl sm:text-4xl font-extrabold text-[#0B1F3B] mb-3", children: [
          "Mobile Repairing –",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-orange-500", children: "India का सबसे तेज़ Growing Career" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-1.5 bg-orange-500 mx-auto rounded-full" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-12 items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 reveal", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-gray-700 leading-relaxed text-lg", children: [
            "India is home to",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-[#0B1F3B]", children: "750 million+ smartphone users" }),
            ", and this number grows by millions every year. With every new phone sold, the demand for skilled repair technicians skyrockets. Over",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-[#0B1F3B]", children: "150 million phones are repaired annually" }),
            " ",
            "in India alone — a market worth thousands of crores of rupees."
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-gray-700 leading-relaxed text-lg", children: [
            "Unlike other professions that require years of expensive degrees, mobile repairing offers",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-[#0B1F3B]", children: "financial independence in just 90 days" }),
            ". Skilled technicians earn ₹40,000–₹50,000+ per month, and those with chip-level expertise are even getting international opportunities in the Gulf and beyond."
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-gray-700 leading-relaxed text-lg", children: [
            "The best part? You can",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-[#0B1F3B]", children: "start your own shop" }),
            ", work from home, or join a service center. Bihar's youth are now choosing mobile repairing as their path to a better future — and Z.info is leading that transformation."
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-4 reveal", children: [
          {
            icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Smartphone, { className: "w-8 h-8" }),
            stat: "750M+",
          ...
          {
            icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Store, { className: "w-8 h-8" }),
            stat: "5 Lac+",
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-orange-500 mb-2", children: item.icon }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-extrabold text-[#0B1F3B]", children: item.stat }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-600 mt-1", children: item.label })
            ]
          },
          item.label
        )) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "courses", className: "py-20 bg-[#F4FBFF]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12 reveal", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block bg-orange-50 text-orange-600 text-xs font-bold uppercase tracking-widest px-4 py-1.5 rounded-full mb-4", children: "Curriculum" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-3xl sm:text-4xl font-extrabold text-[#0B1F3B] mb-3", children: [
          "Our Top ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-orange-500", children: "Courses" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 max-w-xl mx-auto", children: "Complete hands-on training covering every aspect of mobile repairing" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-1.5 bg-orange-500 mx-auto rounded-full mt-4" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-6", children: topics.map((topic, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "bg-white rounded-2xl p-6 shadow-card card-hover border border-gray-100 reveal",
          style: { transitionDelay: `${i * 60}ms` },
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 rounded-2xl bg-gradient-to-br from-[#0B1F3B] to-[#1F5E8D] flex items-center justify-center text-white mb-4", children: topic.icon }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-[#0B1F3B] mb-3 text-base leading-snug", children: topic.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-orange-600 text-sm mb-2 leading-relaxed font-medium", children: topic.hindi }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-sm leading-relaxed", children: topic.english })
          ]
        },
        topic.title
      )) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "students", className: "py-20 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12 reveal", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block bg-orange-50 text-orange-600 text-xs font-bold uppercase tracking-widest px-4 py-1.5 rounded-full mb-4", children: "Success Stories" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-3xl sm:text-4xl font-extrabold text-[#0B1F3B] mb-3", children: [
          "हमारे Students की",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-orange-500", children: "Success Stories" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-1.5 bg-orange-500 mx-auto rounded-full" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-6", children: students.map((student, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-[#0B1F3B] text-sm", children: student.name }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex text-yellow-400 mb-2", children: [1, 2, 3, 4, 5].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-3.5 h-3.5 fill-current" }, s)) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-gray-600 text-sm italic leading-relaxed mb-3", children: [
              '"',
              student.quote,
              '"'
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-green-50 rounded-xl px-3 py-2 flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(IndianRupee, { className: "w-4 h-4 text-green-600" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500", children: "Monthly Earning" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-extrabold text-green-700 text-sm", children: [
                  student.salary,
                  "/month"
                ] })
              ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "py-16 bg-gradient-to-r from-[#F47C20] via-[#FF8A2A] to-[#F47C20] relative overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-4 text-center text-white reveal", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl sm:text-4xl font-extrabold mb-4", children: "अभी Join करें और अपना Future Secure करें!" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl mb-8 opacity-90", children: "2 Days FREE Demo • 90 Days Full Course • 100% Job Guarantee • ₹40K–50K+ Salary" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap justify-center gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "tel:8340505173", "data-ocid": "promo.primary_button", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { className: "bg-white text-orange-600 hover:bg-orange-50 rounded-full px-8 py-6 text-base font-bold shadow-lg transition-all hover:scale-105", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "w-5 h-5 mr-2" }),
            "Call: 8340505173"
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#enquiry", "data-ocid": "promo.secondary_button", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              variant: "outline",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "enquiry", className: "py-20 bg-[#F4FBFF]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-2xl mx-auto px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#0B1F3B] rounded-3xl p-8 sm:p-10 shadow-2xl reveal", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block bg-orange-500/20 text-orange-300 text-xs font-bold uppercase tracking-widest px-4 py-1.5 rounded-full mb-4", children: "Free Demo" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl sm:text-3xl font-extrabold text-white mb-2", children: "ENQUIRE NOW" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-blue-200", children: "Free Demo के लिए Register करें" })
      ] }),
      submitted ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white text-xl font-bold mb-2", children: "आपका Registration हो गया!" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-blue-200", children: "हम जल्द आपसे संपर्क करेंगे।" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 bg-gradient-to-r from-red-600 to-red-700", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto px-4 text-center text-white reveal", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Youtube, { className: "w-16 h-16 mx-auto mb-4 opacity-90" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl sm:text-3xl font-extrabold mb-3", children: "हमारे YouTube Channel को Subscribe करें" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-red-200 mb-6", children: "Free tutorials, tips, and tricks for mobile repairing – all in Hindi!" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "a",
        {
          href: "https://youtube.com/@Z.info7771",
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { className: "bg-white text-red-600 hover:bg-red-50 rounded-full px-8 py-5 text-base font-bold shadow-lg transition-all hover:scale-105", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Youtube, { className: "w-5 h-5 mr-2" }),
            "Subscribe @Z.info7771"
          ] })
        }
      )
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-[#0B1F3B] text-white pt-16 pb-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-xl bg-orange-500 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-extrabold text-lg", children: "Z" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-extrabold text-xl", children: "Z.info" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-blue-200 text-sm leading-relaxed mb-3", children: "Z.info Mobile Training Institute" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-blue-200 text-sm italic mb-4", children: '"हुनर है तो कदर है"' }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2 text-blue-300 text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-4 h-4 mt-0.5 text-orange-400 shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Hajipur, Vaishali, Bihar" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-lg mb-4 text-orange-400", children: "Contact Us" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "w-4 h-4 text-orange-400" }),
                  " 8340505173"
                ]
              }
            ),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Youtube, { className: "w-4 h-4 text-red-400" }),
                  " @Z.info7771"
                ]
              }
            )
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-lg mb-4 text-orange-400", children: "Quick Links" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              href: link.href,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-lg mb-4 text-orange-400", children: "Highlights" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: [
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { className: "w-3.5 h-3.5 text-green-400 shrink-0" }),
                item
              ]
            },
            item
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-white/10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-blue-300 text-sm", children: [
          "© ",
          (/* @__PURE__ */ new Date()).getFullYear(),
          " Z.info Mobile Training Institute. All rights reserved."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-blue-400 text-xs", children: [
          "Built with ❤️ using",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "a",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "w-7 h-7" })
      }
    )
  ] });
}
